<?php
	...
	//teste seguidor
	$esta_seguindo_usuario_sn = isset($registro['id_usuarios_seguidores']) && !empty($registro['id_usuarios_seguidores']) ? 'S' : 'N';
	...
	if($esta_seguindo_usuario_sn == 'N'){
		...
		$btn_seguir_display = 'none';
					...
					echo '<button type="button" id="btn_seguir_'.$registro['id'].'" 
						style="display: '.$btn_seguir_display.'" 
						class="btn btn-default btn_seguir" 
					...
					echo '<button type="button" id="btn_deixar_seguir_'.$registro['id'].'" style="display: '.$btn_deixar_seguir_display.'" 
						class="btn btn-primary btn_deixar_seguir" 
						data-id_usuario="'.$registro['id'].'">Deixar de Seguir</button>';
